...
| Wick to Gap Ratio | float | 0.75 | 0.0+ | Minimum ratio (Low Wick / GAP) required |
...
```
  ...
  - A < 0.75 * B (low wick shorter than 0.75x the gap to higher EMA)
...
| 1.3 | 2026-01-11 | Refined trigger geometry: reduced wick_to_gap_ratio to 0.75 |
